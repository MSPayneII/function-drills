...
function greeting(name) {
  let nameStrConvert = String(name);
  console.log(`Hello, ${nameStrConvert}!`);
}
...
function add(param1, param2) {
  let param1NumConvert = Number(param1);
  let param2NumConvert = Number(param2);

  return param1NumConvert + param2NumConvert;
}
...
function faveColorFinder(color) {
  let strConvertedColor = String(color);
  if (strConvertedColor === "red") {
    return "red is a great color";
  } else if (strConvertedColor === "green") {
    return "green is a solid favorite";
  } else if (strConvertedColor === "black") {
    return "so trendy";
  } else {
...
let testArray = [101, 90, 125, 70, 40];
...
//CODE HERE
function upperChars(str) {
  console.log(str.toUpperCase());
}

console.log(upperChars(sampleString));
...
function emailCheck(email) {
  let updatedEmail = String(email).trim();
...
// console.log(emailCheck("     mpayneiumich.edu   "));
console.log(emailCheck("     mpaynei@umich.edu   "));
...
//CODE HERE
function frogsBought(goldNum) {
  return goldNum / 3;
}

let totalFrogs = frogsBought(12);
...
//CODE HERE
function frogsBought(goldNum) {
  return Math.floor(goldNum / 3);
}

let totalFrogs2 = frogsBought(4);
console.log(totalFrogs2);

////////////////// PROBLEM 15 ////////////////////
let sampleArray = [0, 1, 2, 3, 4, 7, 5, 6, 8, 9];
// let sampleArray = [0, 1, 2, 3, 4, 5, 7, 8, 9, 10];
/*
